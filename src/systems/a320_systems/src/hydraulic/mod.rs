...
impl A320ElevatorFactory {
    ...
    fn new_elevator(context: &mut InitContext, id: ActuatorSide) -> ElevatorAssembly {
        ...
        ElevatorAssembly::new(
            ...
            id,
            assembly,
            A320ElevatorFactory::new_a320_elevator_aero_model(),
        )
    }

    fn new_a320_elevator_aero_model() -> AerodynamicModel {
        let body = A320ElevatorFactory::a320_elevator_body();
        AerodynamicModel::new(
            &body,
            Some(Vector3::new(0., 1., 0.)),
            Some(Vector3::new(0., 0., 1.)),
...
impl A320RudderFactory {
    ...
    fn new_rudder(context: &mut InitContext) -> RudderAssembly {
        ...
        RudderAssembly::new(
            context,
            assembly,
            A320RudderFactory::new_a320_rudder_aero_model(),
        )
    }

    fn new_a320_rudder_aero_model() -> AerodynamicModel {
        let body = A320RudderFactory::a320_rudder_body();
        AerodynamicModel::new(
            &body,
            Some(Vector3::new(1., 0., 0.)),
            Some(Vector3::new(0., 0., 1.)),
...
impl ElacComputer {
    ...
    fn update_pressure_hysteresis(
        ...
        if yellow_pressure.get::<psi>() > Self::PRESSURE_AVAILABLE_HIGH_HYSTERESIS_PSI {
            self.yellow_circuit_available = true;
        } else if yellow_pressure.get::<psi>() < Self::PRESSURE_AVAILABLE_LOW_HYSTERESIS_PSI {
            self.yellow_circuit_available = false;
        }
    }
    ...
    fn update(
        ...
        self.update_pressure_hysteresis(blue_pressure, green_pressure, yellow_pressure);
